...
export default function ServicesPage() {
  ...
  const services = [
  {
    ...
    "shortDescription": "Comprehensive home cleaning service covering every room, surface, and corner. Perfect for move-ins, seasonal cleaning, or when your home needs extra attention and care.",
    "features": [
      "Complete top-to-bottom house cleaning",
      "Kitchen and bathroom deep sanitization",
      "Baseboards, windows, and fixture cleaning"
    ],
    "icon": "🏠"
  }
];

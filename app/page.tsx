...
export default function HomePage() {
  ...
  const hero = {
  "heading": "Seattle's Premier Cleaning Service for Spotless Homes and Offices",
  "subheading": "Professional cleaning solutions that save you time while delivering exceptional results throughout the Seattle area.",
  ...
  const features = [
  {
    ...
    "description": "Comprehensive cleaning solutions for homes and offices, including thorough sanitization and detailed attention to every corner and surface."
  }
];
  const services = [
  {
    "title": "Residential Deep Cleaning",
    "description": "Comprehensive home cleaning service including all rooms, bathrooms, kitchen appliances, and detailed sanitization for a spotless living environment.",

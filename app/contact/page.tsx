...
export default function ContactPage() {
  ...
  const email = "test@gitwebhooks.com";
  
  const contactContent = {
  "heading": "Get In Touch Today",
  "description": "Contact Test Git Webhooks Cleaning in Seattle, WA for reliable and professional cleaning services. We're here to help with all your cleaning needs."
};
